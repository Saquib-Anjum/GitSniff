...
const [username,setUsername] = useState('')
  ...
  return (
    <div>
     <form onSubmit={(e)=>onSearch(e,username)} className='max-w-xl mx-auto p-2 sm:w-72'>
			...
			<div className='relative'>
				...
				<input
					type='search'
					id='default-search'
					className='block w-full p-4 ps-10 text-sm rounded-lg bg-clip-padding backdrop-filter backdrop-blur-xl hover:bg-gray-600/10  text-white bg-opacity-10 focus:ring-blue-500 focus:border-blue-500 bg-transparent focus:bg-transparent '
