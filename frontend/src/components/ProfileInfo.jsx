...
import LikeProfile from '../components/LikeProfile.jsx'
const ProfileInfo = ({userProfile}) => {
 const memberSince = formatMemberSince(userProfile.created_at)
  return (
		<div className='lg:w-1/3 w-full flex flex-col gap-2 md:sticky md:top-10'>
			<div className='bg-clip-padding backdrop-filter backdrop-blur-xl hover:bg-gray-600/10  text-white bg-opacity-10 rounded-lg p-4'>
				<div className='flex gap-4 items-center'>
					...
					<LikeProfile userProfile={userProfile}/>
						<a
							...
							target='_blank'
							rel='noreferrer'
							className='bg-clip-padding backdrop-filter backdrop-blur-xl hover:bg-gray-600/10  text-white bg-opacity-10 font-medium w-full text-xs p-2 rounded-md cursor-pointer border border-blue-400 flex items-center gap-2'
						>
							<FaEye size={16} />
							View on Github
						</a>
			...
			<div className='flex flex-wrap gap-2 mx-4'>
				{/* Followers Count */}
				<div className='flex items-center gap-2 bg-clip-padding backdrop-filter backdrop-blur-xl hover:bg-gray-600/10  text-white bg-opacity-10 rounded-lg p-2 flex-1 min-w-24'>
