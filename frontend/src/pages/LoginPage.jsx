...
import {handleLoginWithGithub} from '../lib/handleLoginWithGithub.js'
const LoginPage = () => {
  return (
    <div className='flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0'>
    <div className='w-full bg-clip-padding backdrop-filter backdrop-blur-xl hover:bg-gray-600/10  text-white bg-opacity-10 rounded-lg shadow md:mt-0 sm:max-w-md xl:p-0'>
